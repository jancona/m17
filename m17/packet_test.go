	...
	tests := []struct {
		...
		{"happy",
			args{[]byte{
				...
				0x59, 0x4c,
				0x5,
				0x48, 0x65, 0x6c, 0x6c, 0x6f, 0x20, 0x66, 0x72, 0x6f, 0x6d, 0x20, 0x6d, 0x65, 0x21,
			}},
			Packet{
				LSF: LSF{
					...
					CRC:  []uint8{0x59, 0x4c}},
				Type:    5,
				Payload: []uint8{0x48, 0x65, 0x6c, 0x6c, 0x6f, 0x20, 0x66, 0x72, 0x6f, 0x6d, 0x20, 0x6d, 0x65, 0x21},
			},
		},
	}
	for _, tt := range tests {
